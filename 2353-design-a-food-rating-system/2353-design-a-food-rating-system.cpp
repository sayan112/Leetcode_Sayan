class FoodRatings
{
    ...
    public:
        unordered_map<string, set<pair<int, string>, cmp>> cusionToFood;
    ...
    void changeRating(string food, int newRating)
    {
        ...
        rate[food] = newRating;
        cusionToFood[cuision].erase({ prevrating,
            food });
        cusionToFood[cuision].insert({ newRating,
            food });
    }
    ...
    string highestRated(string cuisine)
    {
        ...
        auto ans= cusionToFood[cuisine].begin();
         return ans->second;
    }
};
